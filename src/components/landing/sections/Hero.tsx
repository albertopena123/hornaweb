...
const HERO_CANDIDATES: HeroCandidate[] = [
  ...
  },
  {
    ...
    cargoBadge: "Candidato a Alcalde Provincial 2027–2030",
    cargoCompleto: "Alcalde Provincial de Tahuamanu",
    ambito: "Tahuamanu",
    ambitoSub: "Iñapari · Iberia · San Lorenzo · Tahuamanu",
    tipo: "provincial",
    cita: "Conectividad integral vial y fronteriza, desarrollo productivo y valor a nuestras comunidades originarias.",
    frases: [
      "Conectividad vial y desarrollo productivo en Tahuamanu.",
      "Rutas seguras e integración fronteriza los 365 días.",
      "Desarrollo agroforestal y apoyo a comunidades originarias.",
      "Energía solar limpia y agua tratada en cada comunidad.",
    ],
    descripcion:
      "Candidato a Alcalde Provincial de Tahuamanu por Ahora Nación. Rutas seguras todo el año, integración comercial fronteriza y apoyo directo a comunidades amazónicas.",
    imageCutout: "/assets/images/candidatos/yilmer-gonzales-cutout.webp",
    stats: [
      { to: 3, s: "", label: "Distritos\nIntegrados", icon: MapPin, color: "#2ECC71", bg: "rgba(46,204,113,.12)" },
      { to: 100, s: "%", label: "Rutas Viales\nSeguras", icon: Compass, color: "#4A9EFF", bg: "rgba(74,158,255,.12)" },
