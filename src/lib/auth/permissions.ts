...
export const ROLE_DEFS = [
  ...
  {
    key: "coordinador_departamental",
    name: "Coordinador Departamental / General",
    description: "Coordinación y supervisión general de todo el departamento: provincias, distritos, locales y personeros.",
    system: true,
    permissions: [
      "users.read",
      "supporters.read",
  ...
  {
    key: "coordinador_provincial",
    name: "Coordinador Provincial",
    description: "Acceso y monitoreo de colegios, mesas, actas y personeros de su provincia asignada.",
    system: true,
    permissions: [
      "personeros.read",
      "personeros.write",
  ...
  {
    key: "coordinador_distrital",
    name: "Coordinador Distrital",
    description: "Acceso y monitoreo de colegios, mesas, actas y personeros de su distrito asignado.",
    system: true,
    permissions: [
      "personeros.read",
      "personeros.write",
